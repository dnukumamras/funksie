...
module.exports = Joi.object({
    accelerometerSrc: Joi.array().items(Joi.string()).single(),
    ambientLightSensorSrc: Joi.array().items(Joi.string()).single(),
    autoplaySrc: Joi.array().items(Joi.string()).single(),
    batterySrc: Joi.array().items(Joi.string()).single(),
    cameraSrc: Joi.array().items(Joi.string()).single(),
